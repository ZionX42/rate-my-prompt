    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com/prompthub" className="text-gray-300 hover:text-white">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-300">© 2025 Prompt Hub. All rights reserved.</p>
          <p className="text-gray-300 mt-2 md:mt-0">Designed with ❤️ for the AI community</p>
        </div>
      </div>
    </footer>
  );
